<template>
    ...
    <img src="../assets/imagens/foto-banner.png" alt="Foto de uma mulher cozinhando com uma bacia de vidro nas mãos, sorrindo e apoiando o celular entre o rosto e o ombro." class="foto-banner">
  </header>
</template>
